...
def calculate_sarima_forecast(data, order=(1,1,1), steps=7):
    ...
    model = SARIMAX(data['Quantity ordered new'], order=order, enforce_stationarity=False, enforce_invertibility=False)
